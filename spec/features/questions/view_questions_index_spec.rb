...
feature 'view the questions index', %{
  ...
  # Acceptance Criteria
  # [ ] User can navigate to the questions index from the homepage
  # [ ] User can navigate to the questions index from the nav bar
  # [ ] User views all of their own questions
  # [ ] User cannot see a question created by a different user
  # [ ] Only authenticated users can view the questions index
